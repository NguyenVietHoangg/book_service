...
const _generate_camel_case_Sv = sv._table_generate_
...
router.post(`/_table_generate_/get_table_generate_camel_case_List`, async (req, res) =>{
  ...
  const data = await _generate_camel_case_Sv.get_table_generate_camel_case_List(conds, page)
 ...
 */
 router.get(`/_table_generate_/get_table_generate_camel_case_DetailById/:id`, async (req, res) =>{
  ...
  let data = await _generate_camel_case_Sv.get_table_generate_DetailById(id)
  if (!data) {
 ...
 */
 router.post(`/_table_generate_/save_table_generate_camel_case_DetailById/:id`, async (req, res) =>{
  ...
  const result = await _generate_camel_case_Sv.save_table_generate_camel_case_DetailById(id, data)
  if (!result) {
