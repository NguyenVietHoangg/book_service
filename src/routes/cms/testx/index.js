...
const _generate_camel_case_Sv = sv.testx
const CommonSv = sv.commonSv
/**
 * get pagination list on testx
 */
router.post(`/testx/getundefinedList`, async (req, res) =>{
 ...
 */
 router.get(`/testx/getundefinedDetailById/:id`, async (req, res) =>{
  const id = req.params.id
  let data = await _generate_camel_case_Sv.gettestxDetailById(id)
  if (!data) {
 ...
 */
 router.post(`/testx/saveundefinedDetailById/:id`, async (req, res) =>{
  const id = req.params.id
