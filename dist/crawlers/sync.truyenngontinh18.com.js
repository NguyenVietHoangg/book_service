...
var PREFIX_SOURCE = 'truyenngontinh18.com';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (!url) {
            url = 'https://truyenngontinh18.com/dong-chi/';
            // return;
          }
          _context.next = 5;
        ...
        case 16:
          ...
          linkPageAjax = 'https://truyenngontinh18.com/wp-admin/admin-ajax.php';
          storyIdCrawler = selector('#wrap').find('#id_post').val();
          ...
          linkPageChapter = paginate === 1 ? url : !textfinalPaginate.includes('Cuối') ? selector(result.find('.pagination.pagination-sm a')[paginate - 1]).attr('href') : selector(result.find('.pagination.pagination-sm a')[paginate - 1]).attr('href');
        ...
        case 45:
          ...
          totalPage = finalChapterArr[5] ? finalChapterArr[5] : 1; // console.log(totalPage); return;
          slugStory = finalChapterArr[3];
          slugTmp = finalChapterArr[3];
          listPageChapter = [];
          totalChapter = (totalPage - 1) * 10 + countStoryPageFinal; // random image
          _context.next = 54;
        ...
        case 108:
          ...
          listLinks = selectorChapter('.col-xs-12 .list-chapter').find('a');
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(link, storyId, slugStory) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 14:
          chapter = selector('#chapter-c.chapter-c').find('br');
          chapterName = (0, _common.clearUnicode)(selector('#wrap .row .chapter-title').text());
          firstDom = selector('#chapter-c.chapter-c').find('br')[0];
          ...
          if (arr.length < 3) {
            chapter = selector('#wrap .chapter-content').find('p');
            arr = chapter.map(function (index, el) {
    ...
    }, _callee2, null, [[4, 10], [30, 35]]);
  }));
  return function getChapter(_x, _x2, _x3) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 1:
          ...
          endpoint = 'https://truyenfull.vn/danh-sach/truyen-moi/trang-' + i;
          links = null;
          _context4.prev = 4;
          _context4.next = 7;
        ...
        case 14:
          links.map(function (item) {
            if (item.includes('truyenfull.vn')) {
              ...
              _syncTruyentr["default"].getStoryDetail(item);
            } else if (item.includes('truyentr.org')) {
              _syncTruyentr["default"].getStoryDetail(item);
            } else {
              _syncViBlogtamsu["default"].getStoryDetail(item);
            }
          });
        case 15:
          i--;
