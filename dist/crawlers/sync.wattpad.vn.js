    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          console.log("============= Bắt đầu quét lấy nội dung chương của wattpad page " + page);
        ...
        case 14:
          ...
          break;
        case 17:
          console.log("============= Hoàn thành quét xong quét lấy nội dung chương của wattpad page " + page);
        case 18:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          _context16.next = 2;
          return Model.story.findAll({
            attributes: ['name', 'source_crawler_1'],
            include: {
              model: Model.collection_story,
              where: {
                collectionId: 1
              },
              required: true
        ...
        case 5:
          ...
          console.log('========== topHot ========' + data[i].name + ':' + data[i].source_crawler_1);
          _context16.next = 9;
          return getStoryDetail(data[i].source_crawler_1);
        case 9:
          i++;
          _context16.next = 5;
          break;
        case 12:
          console.log('xong Top Hot');
        case 13:
        case "end":
