...
var castCategoryObj = function castCategoryObj(obj) {
  return {
    name: obj.text,
    slug: (0, _common.xoaDau)(obj.text),
    source_crawler: obj.link
  };
};
var castStoryObj = function castStoryObj(obj) {
  return {
    name: obj.title,
    slug: (0, _common.xoaDau)(obj.title),
...
var castChapterObj = function castChapterObj(obj) {
  var chapterOrder = false;
  var linkSplit = obj.link.split('/chuong-');
  ...
  return {
    ...
    slugUnique: (0, _common.xoaDau)(obj.storyTitle.trim() + '-atruyenhay-' + obj.title),
    source_crawler_1: obj.link,
    chapterOrder: chapterOrder ? parseInt(chapterOrder) : null,
    storyId: obj.storyId
  };
};
var castChapterUpdateObj = function castChapterUpdateObj(obj) {
  var tet = obj.data ? JSON.stringify(obj.data) : null;
...
var _default = exports["default"] = {
  castCategoryObj: castCategoryObj,
  castStoryObj: castStoryObj,
  castChapterObj: castChapterObj,
  castChapterUpdateObj: castChapterUpdateObj
};