...
exports.saveCategoryDetailById = exports.getCategoryParentList = exports.getCategoryList = exports.getCategoryDetailById = exports["default"] = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          _yield$Model$category = _context.sent;
          count = _yield$Model$category.count;
          rows = _yield$Model$category.rows;
...
var getCategoryDetailById = exports.getCategoryDetailById = /*#__PURE__*/function () {
  ...
  return function getCategoryDetailById(_x) {
    return _ref2.apply(this, arguments);
  };
}();
var getCategoryParentList = exports.getCategoryParentList = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var detail, rows, parentList;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return getCategoryDetailById(id);
        case 2:
          detail = _context3.sent;
          _context3.next = 5;
          return Model.category.findAll({
            where: {
              parentId: _defineProperty({}, Model.Sequelize.Op.eq, null),
              id: _defineProperty({}, Model.Sequelize.Op.not, id),
              updatedAt: _defineProperty({}, Model.Sequelize.Op.not, null),
              name: _defineProperty({}, Model.Sequelize.Op.not, '')
            },
            include: [{
              model: Model.media
            }, {
        ...
        case 5:
          rows = _context3.sent;
          parentList = rows.map(function (item) {
            item = item.toJSON();
            item.text = item.name;
          ...
          return _context3.abrupt("return", parentList);
        case 8:
        case "end":
  ...
  return function getCategoryParentList(_x2) {
    return _ref3.apply(this, arguments);
  };
}();
var saveCategoryDetailById = exports.saveCategoryDetailById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          _context4.next = 8;
          return Model.category.create(Model.setupInsert({}));
        case 8:
          item = _context4.sent;
        case 9:
          id = item.id;
        ...
        case 17:
          ...
          _context4.next = 22;
          return Model.category.update(Model.setupUpdate(data), {
            where: {
              id: id
            }
          });
  ...
  return function saveCategoryDetailById(_x3, _x4) {
