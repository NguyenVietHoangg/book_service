...
exports.saveCollectionDetailById = exports.getCollectionList = exports.getCollectionDetailById = exports["default"] = void 0;
...
var getCollectionList = exports.getCollectionList = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 12;
          return Model.collection.findAndCountAll({
            where: where,
            include: include,
            offset: offset,
            limit: _common.LIMIT
        ...
        case 12:
          _yield$Model$collecti = _context.sent;
          count = _yield$Model$collecti.count;
          rows = _yield$Model$collecti.rows;
...
var getCollectionDetailById = exports.getCollectionDetailById = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          if (row.categories && row.categories.length) {
            row.dataValues.collectionIds = row.categories.map(function (item) {
              return item.id;
            });
          }
  ...
  return function getCollectionDetailById(_x) {
    return _ref2.apply(this, arguments);
  };
}();
var saveCollectionDetailById = exports.saveCollectionDetailById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 8;
          return Model.collection.create(Model.setupInsert({}));
        case 8:
          item = _context3.sent;
        case 9:
          id = item.id;
        ...
        case 17:
          ...
          _context3.next = 22;
          return Model.collection.update(Model.setupUpdate(data), {
            where: {
              id: id
            }
          });
  ...
  return function saveCollectionDetailById(_x2, _x3) {
    return _ref3.apply(this, arguments);
  };
}();
var _default = exports["default"] = {
  getCollectionList: getCollectionList,
  getCollectionDetailById: getCollectionDetailById,
  saveCollectionDetailById: saveCollectionDetailById
};