    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 12;
          return Model.book.findAndCountAll({
            where: where,
            include: include,
            offset: offset,
            limit: _common.LIMIT
        ...
        case 12:
          _yield$Model$book$fin = _context.sent;
          count = _yield$Model$book$fin.count;
          rows = _yield$Model$book$fin.rows;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          if (rowbook && row.book.length) {
            row.dataValues.book.Ids = row.book.map(function (item) {
              return item.id;
            });
          }
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 8;
          return Model.book.create(Model.setupInsert({}));
        case 8:
          item = _context3.sent;
        case 9:
          id = item.id;
        ...
        case 17:
          ...
          _context3.next = 22;
          return Model.book.update(Model.setupUpdate(data), {
            where: {
              id: id
            }
          });
