...
exports.saveundefinedDetailById = exports.getundefinedList = exports.getundefinedDetailById = exports["default"] = void 0;
...
var getundefinedList = exports.getundefinedList = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 12;
          return Model.testx2.findAndCountAll({
            where: where,
            include: include,
            offset: offset,
            limit: _common.LIMIT
        ...
        case 12:
          _yield$Model$testx2$f = _context.sent;
          count = _yield$Model$testx2$f.count;
          rows = _yield$Model$testx2$f.rows;
  ...
  return function getundefinedList() {
    return _ref.apply(this, arguments);
  };
}();
var getundefinedDetailById = exports.getundefinedDetailById = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          row = _context2.sent;
          if (rowtestx2 && row.testx2.length) {
            row.dataValues.testx2.Ids = row.testx2.map(function (item) {
              return item.id;
            });
          }
  ...
  return function getundefinedDetailById(_x) {
    return _ref2.apply(this, arguments);
  };
}();
var saveundefinedDetailById = exports.saveundefinedDetailById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 8;
          return Model.testx2.create(Model.setupInsert({}));
        case 8:
          item = _context3.sent;
        case 9:
          id = item.id;
        ...
        case 17:
          ...
          _context3.next = 22;
          return Model.testx2.update(Model.setupUpdate(data), {
            where: {
              id: id
            }
          });
  ...
  return function saveundefinedDetailById(_x2, _x3) {
