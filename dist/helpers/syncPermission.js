...
exports.syncPermissions = void 0;
var _lodash = _interopRequireDefault(require("lodash"));
var dbz = _interopRequireWildcard(require("./../adapters/fetchData"));
...
var routePublic = [];
var syncPermissions = exports.syncPermissions = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          arrays = _args.length > 0 && _args[0] !== undefined ? _args[0] : [];
          _context.prev = 1;
          if (!(arrays.length === 0)) {
            _context.next = 4;
            break;
        ...
        case 11:
          iMt = 0;
        case 12:
          if (!(iMt < arrays[iArr].methods.length)) {
            _context.next = 20;
            break;
          }
          _context.next = 15;
          return dbz.fetchOne(table, {
            where: {
        ...
        case 23:
          if (arraysInsert.length) {
            try {
              Model.permission.bulkCreate(arraysInsert, {
        ...
        case 26:
          ...
          console.log('=== syncPermission', _context.t0);
        case 29:
        case "end":
  ...
  return function syncPermissions() {
