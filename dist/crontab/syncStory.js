...
exports.syncChapterNewest = exports.itemSyncChapterNewest = exports["default"] = void 0;
...
var itemSyncChapterNewest = exports.itemSyncChapterNewest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var storyId,
      item,
      _yield$db$chapter$fin,
      count,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          storyId = _args.length > 0 && _args[0] !== undefined ? _args[0] : null;
          if (storyId) {
            _context.next = 3;
            break;
          }
        ...
        case 5:
          item = _context.sent;
          _context.next = 8;
          return db.chapter.findAndCountAll({
            where: {
              storyId: storyId
            },
            limit: 1
        ...
        case 8:
          _yield$db$chapter$fin = _context.sent;
          count = _yield$db$chapter$fin.count;
          db.story.update({
            totalChapter: count,
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          page = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 2;
          offset = 0;
          limit = 1000;
          i = 0;
        case 4:
